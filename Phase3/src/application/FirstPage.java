...
public class FirstPage {
	...
	/**
	 * Constructs a new FirstPage instance.
	 * <p>
	 * This constructor initializes the first page of the application using the provided 
	 * database helper for managing database operations.
	 * </p>
	 *
	 * @param databaseHelper the database helper used to manage database connections and queries
	 */
